    ...
    <nav class="navbar navbar-expand-lg navbar-light sec-nav-bg-color">
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav">
          ...
          <li class="nav-item active pl-2 pr-2">
            <a class="nav-link text-white font-weight-bold" href="{{url('/product/3')}}">3 Pieces</a>
          </li>
          <li class="nav-item active pl-2 pr-2">
            <a class="nav-link text-white font-weight-bold" href="{{url('/product/4')}}">Lungi</a>
          </li>
          <li class="nav-item active pl-2 pr-2">
            <a class="nav-link text-white font-weight-bold" href="{{url('/product/5')}}">Sale</a>
          </li>
