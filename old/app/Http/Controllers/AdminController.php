...
class AdminController extends Controller
{
    ...
    public function productinsert(Request $request){
        ...
        $pricefour =$request->input('pricefour');
        $pricefive =$request->input('pricefive');
        $pricesex =$request->input('pricesex');

        $product_type =$request->input('product_type');
        $product_typetwo =$request->input('product_typetwo');
        $product_typethree =$request->input('product_typethree');
        $product_typefour =$request->input('product_typefour');
        $product_typefive =$request->input('product_typefive');
        $product_typesex =$request->input('product_typesex');
   ...
   $destinationPath = 'images/';
        ...
        $response = Http::post('https://islampurbackend.islampurmarket.com/api/productadd',[
                      'name'=>$brand,
                      ...
                      'discount'=>$discount, 
                      'type'=>$product_type,
                      'type_2'=>$product_typetwo,
                      'type_3'=>$product_typethree,
                      'type_4'=>$product_typefour,
                      'type_5'=>$product_typefive,
                      'type_6'=>$product_typesex,
                      'number'=>$number, 
...
'status'=> null
    ...
    public function productupdate(Request $request){
        ...
        $response = Http::put("https://islampurbackend.islampurmarket.com/api/products/$id",[
                      'name'=>$brand,
                      'price'=>$price,
                      'discount'=>$discount, 
                      'gender_id'=>$gender, 
    ...
    public function contact(){
        ...
        $response = Http::get("https://islampurbackend.islampurmarket.com/api/contruct");
        $results = json_decode($response);
